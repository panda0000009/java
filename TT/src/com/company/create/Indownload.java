...
public class Indownload implements Runnable {
    private String url;
    private String name;

    public Indownload(String url, String name) {
        this.url = url;
        this.name = name;
    }
